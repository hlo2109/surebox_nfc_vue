<template>
	<div class="min-h-screen bg-gray-50">
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center justify-start">
						...
						<button @click="toggleSidebar" type="button"
							...
							<svg v-if="!sidebarOpen" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
						...
						<router-link to="/" class="flex ml-2 md:mr-24">
							<svg class="w-4 h-6 sm:w-8 sm:h-10" viewBox="0 0 92 122" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path
		...
		<!-- Sidebar -->
		<aside id="sidebar"
			:class="['fixed top-0 left-0 z-40 w-72 h-screen pt-20 transition-transform bg-white border-r border-gray-200', sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0']">
			<div class="h-full px-3 pb-4 overflow-y-auto bg-white">
				<!-- Sidebar Brand (visible on mobile when sidebar is open) -->
				<div class="lg:hidden pt-4 pb-6 px-3 border-b border-gray-200 -mt-16 mb-4 bg-white">
					<svg class="w-10 h-12" viewBox="0 0 92 122" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							d="M61.3333 0H92V30.5H61.3333V0ZM30.6667 0H61.3333V30.5H30.6667V0ZM0 30.5H30.6667V61H0V30.5ZM61.3333 61H92V91.5H61.3333V61ZM61.3333 91.5H92V122H61.3333V91.5ZM0 91.5H30.6667V122H0V91.5ZM0 0H30.6667V30.5H0V0ZM30.6667 91.5H61.3333V122H30.6667V91.5Z"
							fill="#0D65AE" />
					</svg>
				...
				<div class="space-y-2">
						...
						<ul class="space-y-1">
							<li>
								<router-link to="/" @click="closeSidebarMobile"
									:class="['flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 border', isActive('/') ? 'bg-[#0D65AE]/5 text-[#0D65AE] border-[#0D65AE]/20' : 'text-gray-700 hover:bg-gray-50 border-transparent']">
									<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
							...
							<li>
								<router-link to="/mybox" @click="closeSidebarMobile"
									:class="['flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 border', isActive('/mybox') || isActive('/create-box') || isActive('/edit-box') ? 'bg-[#0D65AE]/5 text-[#0D65AE] border-[#0D65AE]/20' : 'text-gray-700 hover:bg-gray-50 border-transparent']">
									<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
							...
							<li>
								<router-link to="/delivery" @click="closeSidebarMobile"
									:class="['flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 border', isActive('/delivery') || isActive('/delivery') ? 'bg-[#0D65AE]/5 text-[#0D65AE] border-[#0D65AE]/20' : 'text-gray-700 hover:bg-gray-50 border-transparent']">
									<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
					...
					<div class="pt-4">
						<p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Quick Actions
						</p>
						<ul class="space-y-1">
							<li>
								<router-link to="/create-box" @click="closeSidebarMobile"
					...
					<div class="pt-4 mt-auto">
						<div class="px-3 py-4 bg-[#0D65AE]/5 rounded-lg border border-[#0D65AE]/20">
							<div class="flex items-start gap-3">
								<div class="bg-[#0D65AE] p-2 rounded-lg border border-[#0D65AE]">
								...
								<div>
									...
									<p class="text-xs text-gray-600 mb-2">Learn how to use SureBox</p>
									<button class="text-xs font-medium text-[#0D65AE] hover:underline">
										View Guide →
									</button>
								</div>
							</div>
		...
		<div v-if="sidebarOpen" @click="sidebarOpen = false"
			class="fixed inset-0 z-30 bg-gray-900/50 lg:hidden backdrop-blur-sm transition-opacity"></div>
