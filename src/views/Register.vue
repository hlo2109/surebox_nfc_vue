	...
	<div class="min-h-screen flex flex-col bg-surface-50 light:bg-surface-950">
			...
			<div class="relative z-10 h-full px-6 md:px-10 lg:px-16 flex items-start">
				<div class="w-full pt-4 flex items-center justify-between">
					...
					<button type="button" @click="goBack"
						class="inline-flex items-center gap-2 text-surface-0/90 hover:text-white transition-colors">
		...
		<section class="relative z-20 px-6 md:px-10 lg:px-16 -mt-10 md:-mt-12 pb-10 grow">
			<div
				...
				<!-- Title -->
				<h1 class="text-surface-900 light:text-surface-0 text-2xl font-semibold">Create an Account</h1>
				...
				<!-- Register form -->
				<form @submit="handleRegister" class="flex flex-col gap-6">
					<div class="flex flex-col gap-5 w-full">
						<div class="flex flex-col gap-2 w-full">
							<label for="name1" class="text-zinc-500 text-sm leading-normal">Name</label>
							<InputText id="name1" v-model="name" type="text" placeholder="Your full name"
						...
						<div class="flex flex-col gap-2 w-full">
							<label for="password2" class="text-zinc-500 text-sm leading-normal">Confirm
								password</label>
					...
					<Button type="submit" :disabled="loading" :label="loading ? 'Creating account…' : 'Sign Up'"
						class="w-full py-3 rounded-full text-white font-semibold"
...
// Map background: place an image at public/images/map-bg.jpg
