		...
		<div class="max-w-7xl mx-auto">
			...
			>
				...
				<p class="text-gray-600 max-w-md mx-auto">
					...
					or join a company to manage members.
				</p>
			</div>
			...
			>
				<MembersList
					...
					:members="members"
					:loading="loading"
					:can-add-members="canManageMembers"
...
import { useCompanies, usePermissions } from "@/composables";
...
const { fetchMyCompanyMembers } = useCompanies();
...
async function loadMembers() {
	...
	try {
		...
		if (result.success) {
			...
			loadError.value =
				result.message || "Failed to load members. Please try again.";
		}
	} catch (err) {
		loadError.value =
